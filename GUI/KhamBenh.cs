...
namespace QLPhongMachTu_DOAN_.GUI
{
    public partial class KhamBenh : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            PhieuKham phieuKham = phieuKhamBLL.GetByMaBN(benhNhan.MaSo);
            phieuKham.TrieuChung = phieuKham?.TrieuChung ?? string.Empty;///************
        ...
        private void UpdateDataGrid()
        {
            ...
            foreach (var lk in listOfLichKham)
            {
                ...
                dataGridView1.Rows[index].Cells[5].Value = ((ETrangThaiKham)lk.TrangThai);   // Trạng thái
