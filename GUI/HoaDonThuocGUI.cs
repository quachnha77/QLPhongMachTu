...
namespace QLPhongMachTu_DOAN_.GUI
{
    public partial class HoaDonThuocGUI : Form
    {
        ...
        public void LoadData()
        {
            ...
            List<ChiTietToaThuocDTO> chiTietToaThuocList = chiTietToaThuocBLL.GetChiTietByMaTT(toaThuoc.MaTT);
            int index = 1;
        ...
        public void AddRowToDataGridView(ChiTietToaThuocDTO chiTietToaThuoc, int index)
        {
            DTO.KhoThuocDTO thuoc = khoThuocBLL.GetByMaThuoc(chiTietToaThuoc.MaThuoc);
